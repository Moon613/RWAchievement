...
public class AchievementPage : Page
{
    ...
    public AchievementPage(Menu.Menu menu, MenuObject owner, string name, int index, Vector2 pos, string imageFolder, string imageName, string achievementName, string dateAchieved, string achievementDescription) : base(menu, owner, name, index) {
        ...
        MenuLabel date = new MenuLabel(menu, this, "Date Achieved:\n" + dateAchieved, new Vector2(0, 0.675f*screenCenter.y), Vector2.zero, true);
